...
//	}
	...
	public ResponseEntity<PedidoDTO> order(@RequestPart("pedido") String pedido, @RequestPart("itens") String itens) {
		return new ResponseEntity<>(pedidoService.order(pedido, itens), HttpStatus.CREATED);
	}
